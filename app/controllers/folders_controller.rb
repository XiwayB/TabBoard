class FoldersController < ApplicationController
  ...
  def index
    ...
    # else
    folders = policy_scope(Folder).joins("LEFT JOIN shares ON shares.folder_id = folders.id").where("folders.user_id = :id OR shares.user_id = :id", id: current_user.id).order("folders.importance DESC, folders.updated_at DESC")
